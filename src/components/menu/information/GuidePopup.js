              ...
              <div>
                ...
                <div className='guide-section'>
                  ...
                  <p>The left side of the canvas are the canvas controls. You can toggle the viewpoint of the existing floors and devices. You can also add or delete floors.
                    As stated above, the "GR" is the ground or main floor. You can add up to four floors maximum above or below the main floor, for a total of five floors.
                ...
                <div className='guide-section'>
                  ...
                  <p>
                    ...
                    There is also an object menu that will appear on the right side of the screen. This menu will allow you to fill in objects, adjust certain line thickness, and move forward and backwards
                    from the display. <b>Note:</b> If the object appears behind another object, moving it forward will move it infront of the object.
                  </p>
                  <p>
                ...
                <div className='guide-section'>
                  ...
                  <p><b>Note:</b> The room labels and colors will overlay the whole floor plan. If you wish to continue adding devices or drawing the plan, you can hide the view of the
                    room colors and labels on the viewport menu on the left side of the canvas.</p>
                </div>
              </div>
            }
            ...
            {tabMode === 'step2' &&
              <div>
                ...
                <div className='guide-section'>
                  ...
                  <p>Once you've configured, select <i>add device</i> at the bottom of the popup or top of the entity box which will add the device to the center of your floorplan. You can proceed to click and drag the device to
              ...
              <div>
                ...
                <div className='guide-section'>
                  ...
                  <p>For the Home Assistant yaml files, <b>press the back arrow to access the main folder.</b> Go to add files, and select the each file inside the
                    <b> yaml-files</b> folder. These are titled <b>scripts.yaml</b>, <b>customize.yaml</b> , and <b>configuration.yaml</b>. Once these files have been added, move to section C to add the images.</p>
                </div>
                ...
                <div className='guide-section'>
                  ...
                  <p>To import the floorplan images for the dashboard, you must select <i>add folder</i> at the top of the main directory inside the <i>file editor</i>.
                    ...
                    Smart Floor Planner folder. Select each individual image and upload it into home assistant. If you have chosen to export room dashboards, it is important to go to the <i>rooms</i>
                    folder inside the media folder and upload each individal image from there into the www folder.</p>
                </div>
